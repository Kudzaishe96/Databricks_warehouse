...
# Configuration
SOURCE_PATH = "/Volumes/kue_data_warehousing_source/crm_source/dw_crm_source/source_crm/products/"

# https://docs.databricks.com/aws/en/ingestion/cloud-object-storage/auto-loader/schema
 
@dp.table(
    name="kue_data_warehousing_source.bronze.crm_products",
